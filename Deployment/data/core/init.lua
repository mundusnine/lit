...
function core.init()
  ...
  print(core.root_view)
  print(core.command_view)
  print(core.status_view)
...
local temp_file_prefix = string.format(".lit_temp_%08x", temp_uid)
...
function core.load_project_module()
  local filename = ".lit_project.lua"
...
function core.step()
  ...
  local title = (name ~= "---") and (name .. " - lit") or  "lit"
...
function core.run()
    ...
    -- print("redraw: " .. tostring(did_redraw))
    run_threads()
